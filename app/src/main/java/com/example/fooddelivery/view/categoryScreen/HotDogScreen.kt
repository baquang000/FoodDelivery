...
@Composable
fun HotDogScreen(navController: NavController, hotDogViewModel: HotDogViewModel = viewModel()) {
    Column(
        ...
        Column(
            ...
            SetMoreItem(hotDogViewModel = hotDogViewModel)
        }
    }
}

@Composable
fun SetMoreItem(hotDogViewModel: HotDogViewModel) {
