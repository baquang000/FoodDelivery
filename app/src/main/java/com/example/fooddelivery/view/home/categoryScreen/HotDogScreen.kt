...
import com.example.fooddelivery.data.viewmodel.user.authviewmodel.homeviewmodel.category.HotDogViewModel
...
fun HotDogScreen(
    ...
    val hotdog by hotDogViewModel.hotdogFood.collectAsStateWithLifecycle()
    val isLoad by hotDogViewModel.isLoadHoDog.collectAsStateWithLifecycle()
    Box {
        if (isLoad) {
