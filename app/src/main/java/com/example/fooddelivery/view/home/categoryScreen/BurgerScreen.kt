...
import com.example.fooddelivery.data.viewmodel.user.authviewmodel.homeviewmodel.category.BurgerViewModel
...
fun BurgerScreen(
    ...
    val burger by burgerViewModel.burgerFood.collectAsStateWithLifecycle()
    val isLoad by burgerViewModel.isLoadBurger.collectAsStateWithLifecycle()
    Box {
        if (isLoad) {
