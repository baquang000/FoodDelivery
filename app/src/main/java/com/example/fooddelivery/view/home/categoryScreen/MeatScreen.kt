...
import com.example.fooddelivery.data.viewmodel.user.authviewmodel.homeviewmodel.category.MeatViewModel
...
fun MeatScreen(
    ...
    val meat by meatViewModel.meatFood.collectAsStateWithLifecycle()
    val isLoad by meatViewModel.isLoadMeat.collectAsStateWithLifecycle()
    Box {
        if (isLoad) {
